...
export function writeJSONNew(path, value) {
  const text = JSON.stringify(value, null, 2) + '\n';
  requireThat(Buffer.byteLength(text, 'utf8') <= MAX_BYTES, 'Output exceeds the 1 MiB JSON input limit; select a smaller corpus');
  writeNew(path, text);
}
